...
@EnableJpaRepositories(
        ...
        basePackages = { "com.hypocrates.hypocrates.infrastructure.config.database.clinics" }
)
@Configuration
public class ClinicDatasourceConfiguration {
    ...
    public void startMigration() {
        ...
        List<ClinicSchema> clinics = clinicSchemaRepository.findAll();

        for (ClinicSchema clinicSchema : clinics) {
    ...
    public LocalContainerEntityManagerFactoryBean clinicEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.hypocrates.hypocrates.infrastructure.config.database.clinics")
                .persistenceUnit("clinics")
                .build();
    }
